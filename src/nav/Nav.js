      ...
      <nav className="nav">
        <div className="container container--horizontally-spaced container--vertically-center">
          <div>
            <svg ref={this.navLogo} className="nav__logo" viewBox="0 0 4010 3990" xmlns="http://www.w3.org/2000/svg">
              ...
              <g id="text" transform="translate(0.000000,285.000000) scale(0.100000,-0.100000)" fill="#000000" stroke="none">
                ...
                <path id="simple-cup2" d="M1692 2820 c-41 -10 -102 -52 -130 -90 -24 -32 -52 -126 -52 -174 0
                  -52 31 -143 62 -180 53 -65 97 -81 223 -81 158 0 222 31 272 133 23 48 28 70
                  28 137 0 178 -102 267 -303 264 -37 -1 -82 -5 -100 -9z" />
                <path d="M3320 2121 c-145 -20 -245 -89 -307 -212 l-23 -44 0 118 0 117 -350
                  ...
                  23 -199 33 -277 22z" />
                <path d="M450 2070 l0 -30 96 0 96 0 -5 -867 c-4 -881 -7 -953 -43 -1038 -19
          ...
          <ul className="nav__list">
            <a className="nav__list-item" href="#" onClick={(e) => {e.preventDefault(); scrollToFunction('work');} }>
              Work
            </a>
            <a className="nav__list-item" href="#" onClick={(e) => {e.preventDefault(); scrollToFunction('contact');} }>
              Contact
            </a>
          </ul>
        </div>
